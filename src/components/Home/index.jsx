       ...
       <Menu />
        ...
        <div>
          ...
          <div className="z-0  w-full bg-white">
            ...
            <h1 className="text-center text-blue-600 font-black">Our Team</h1>
            <div className="bg-blue-50 p-2 m-4 sm:grid sm:grid-cols-3 gap-4">
              <div className="bg-white h-80 rounded-sm m-4">
                <div>
                  <img src="" />
                </div>
                <div>
              ...
              <div className="bg-white h-80 rounded-sm m-4"></div>
              <div className="bg-white h-80 rounded-sm m-4"></div>
            </div>
          </div>
        </div>
